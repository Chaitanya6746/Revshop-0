...
<%@ page import="model.Category" %> <!-- Import your Category class -->
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8">
        ...
        <div class="form-container">
            ...
            <form action="AddProductServlet" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="discountPrice" name="discountPrice" class="form-control" step="0.01">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <input type="number" id="thresholdQuantity" name="thresholdQuantity" class="form-control">
                </div>
                <div class="form-group">
